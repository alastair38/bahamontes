...
function dmap_locations() {
    ...
    register_taxonomy( 'local_authority',
    	...
    	array('hierarchical' => true,    /* if this is false, it acts like tags */
    		'labels' => array(
    			'name' => __( 'Local Authorities', 'bahamontestheme' ), /* name of the custom taxonomy */
    			'singular_name' => __( 'Local Authority', 'bahamontestheme' ), /* single taxonomy name */
    			'search_items' =>  __( 'Search Local Authorities', 'bahamontestheme' ), /* search title for taxomony */
    			'all_items' => __( 'All Local Authorities', 'bahamontestheme' ), /* all title for taxonomies */
    			'parent_item' => __( 'Parent Local Authority', 'bahamontestheme' ), /* parent title for taxonomy */
    			'parent_item_colon' => __( 'Parent Local Authority:', 'bahamontestheme' ), /* parent taxonomy title */
    			'edit_item' => __( 'Edit Local Authority', 'bahamontestheme' ), /* edit custom taxonomy title */
    			'update_item' => __( 'Update Local Authority', 'bahamontestheme' ), /* update title for taxonomy */
    			'add_new_item' => __( 'Add New Local Authority', 'bahamontestheme' ), /* add new title for taxonomy */
    			'new_item_name' => __( 'New Local Authority Name', 'bahamontestheme' ) /* name title for taxonomy */
    		),
 ...
 register_taxonomy( 'problem_type',
    	...
    	array('hierarchical' => true,     /* if this is true, it acts like categories */
    		'labels' => array(
    			'name' => __( 'Problem Types', 'bahamontestheme' ), /* name of the custom taxonomy */
    			'singular_name' => __( 'Problem Type', 'bahamontestheme' ), /* single taxonomy name */
    			'search_items' =>  __( 'Search Problem Types', 'bahamontestheme' ), /* search title for taxomony */
    			'all_items' => __( 'All Problem Types', 'bahamontestheme' ), /* all title for taxonomies */
    			...
    			'edit_item' => __( 'Edit Problem Type', 'bahamontestheme' ), /* edit custom taxonomy title */
    			'update_item' => __( 'Update Problem Type', 'bahamontestheme' ), /* update title for taxonomy */
    			'add_new_item' => __( 'Add New Problem Type', 'bahamontestheme' ), /* add new title for taxonomy */
    			'new_item_name' => __( 'New Problem Type Name', 'bahamontestheme' ) /* name title for taxonomy */
    		),
    		'show_admin_column' => true,
    		'show_ui' => true,
    		'query_var' => true,
